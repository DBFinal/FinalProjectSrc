...
echo "<div class=\"container\">\r\n";
	...
	if ($res != false)
	{
		if ($res->num_rows > 0)
		{
			...
			echo "<button type=\"submit\" id=\"fulfill\" name=\"fulfill\" class=\"btn btn-info\">Delete</button>\r\n";
			echo "</form>\r\n";
			echo "</div>\r\n";
	...
	if (isset($_POST["fulfill"]) && isset($_SESSION["goodbye"]))
{
		...
		{
			result_message("error","Could not delete employee!","danger");
		}
...
<div class="well">
<form class="form-horizontal" method="POST" action="editStaff.php">
